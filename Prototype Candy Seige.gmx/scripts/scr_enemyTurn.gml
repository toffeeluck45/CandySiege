...
/*if(x < xprevious && y == yprevious) image_angle = 180; //Move left
    ...
    if(image_angle >= 270 && image_angle != 360) image_angle += 4; //Down left turn
    else if(image_angle >= 0 && image_angle <270) image_angle -= 4; //Down right turn
}
else if(x > xprevious && y == yprevious) image_angle = 0; //Move right
